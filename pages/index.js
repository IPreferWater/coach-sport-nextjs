...
export default class Home extends React.Component {
  ...
  <div>
        <div className=" text-7xl md:my-4 font-bold text-center">seances</div>
          ...
          <div className="flex flex-col md:flex-row justify-between w-full">
          <div className="w-full lg:w-1/2">
          <div className="text-4xl text-center" >Jujitsu</div>
          ...
          <div className=" my-4">
          <div className="text-2xl w-full">cours de jujitsu brésilien dans un dojo privé</div>
         {/* <div className="flex flex-row justify-center">
           <Link  href={"https://www.google.com/maps/@50.6444298,3.0488013,18z"}>
                            <a className=" px-4" target="_blank">
                            lien googlemap<img src="data:image/png;base64,"></img>
          ...
          <div className="text-3xl bold flex flex-col space-y-6 md:space-y-10">
            <div>
            <div>🦍 Dimanche 9h30 - 12h00 jujitsu</div>
            </div>
          <div>

          </div>
          <div>🦧 Jeudi 17h00 - 19h00 jujitsu</div>
          </div>
          </div> 
          </div>
